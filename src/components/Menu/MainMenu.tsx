    ...
    >
          ...
          >
            ...
            >
              ...
              <path
                ...
                id='path933'
              />
              <path d='m 3240,2035 c -2160,1310 -1080,655 0,0 z' id='path935' />
            </g>
          </svg>
        </Link>
        <MainMenuLink href='/about'>About</MainMenuLink>
        <MainMenuLink href='/projects'>Projects</MainMenuLink>
      ...
      <HStack>
        <IconButton
          ...
          icon={<Icon as={colorMode === 'light' ? FaMoon : FaSun}></Icon>}
        ></IconButton>
        <Link href='https://github.com/dreitagebart' passHref>
          <IconButton
            variant='ghost'
            aria-label='dreitagebart@github'
            icon={<Icon as={FaGithub}></Icon>}
          ></IconButton>
        </Link>
      </HStack>
    </Box>
